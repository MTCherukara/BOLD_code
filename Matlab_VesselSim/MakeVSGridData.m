...
tau = (-16:8:64)./1000;
% tau = (-24:12:96)./1000;
% tau = [-16, -12, -8, -4, 0, 4, 8, 12, 32, 48, 64]./1000;
...
fulldata = load('../../Data/vesselsim_data/vs_arrays/DataRND_5_TE_80_tau_64_lauwers_100.mat');
...
dname = strcat('ASE_Grid_RND_Lauwers5_TE_',num2str(1000*TE),'_tau_',num2str(1000*tau(end)));
% dname = strcat('ASE_Bootstrap_Sharan_1000_TE_',num2str(1000*TE),'_skip_',num2str(Rind));
% dname = strcat('ASE_Grid_RND_Sharan4_1000_TE_',num2str(1000*TE),'_set_7');
