...
fulldata = load('../../Data/vesselsim_data/vs_arrays/DataRND_8_TE_80_tau_64_lauwers_100.mat');
...
dname = strcat('ASE_Grid_RND_Lauwers8_TE_',num2str(1000*TE),'_tau_',num2str(1000*tau(end)));
