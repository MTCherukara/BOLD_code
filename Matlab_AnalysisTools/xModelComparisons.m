...
PrecOEF = [ 1e-3, 1e-2, 1e-1, 1e0 , 1e1 , 1e2];
PrecDBV = [ 1e2 , 1e1 , 1e0 , 1e-1, 1e-2 ];

% P(OEF)      1e-3       1e-2       1e-1       1e0        1e1        1e2
Err_OEF = [ 100.0000,  100.0000,   45.4000,    3.9900,    3.2000,    4.6600; ...
            100.0000,  100.0000,    4.4000,    3.4600,    3.0200,    5.4500; ...
            100.0000,  100.0000,    4.1100,    3.1800,    3.2500,    6.4000; ...
            100.0000,  100.0000,    3.8900,    3.1200,    3.4200,    6.7400; ...
            100.0000,  100.0000,    3.8400,    3.1100,    3.4500,    6.7900 ];
        
% P(OEF)      1e-3       1e-2       1e-1       1e0        1e1        1e2
Err_DBV = [   3.9700,    3.1200,    2.0400,    0.5600,    0.4700,    0.7000; ...
            100.0000,  100.0000,    0.5500,    0.4700,    0.4400,    0.8300; ...
            100.0000,  100.0000,    0.5100,    0.4400,    0.4700,    1.0100; ...
            100.0000,  100.0000,    0.4800,    0.4400,    0.4900,    1.0700; ...
            100.0000,  100.0000,    0.4700,    0.4400,    0.4900,    1.0800 ];
...
ylabel('DBV Error (%)');
xlabel('Precision (DBV)');
legend('Prec(OEF) = 10^-^1','Prec(OEF) = 10^0',...
       'Prec(OEF) = 10^1','Prec(OEF) = 10^2',...
       'Location','NorthEast');
