...
legtext = {'L','1C','2C','1C(s)','2C(s)','L Model VB','Powder','Powder(s)','Linear','L (11\tau)','1C (11\tau)','2C (11\tau)','1C (11\tau)','2C (11\tau)'};
...
R2p = [ 3.1480,    3.6560,    2.9520,    3.5170,    3.0660,    3.5430,    2.7650; ...       % Linear
        ...
        2.8990,    3.1600,    3.1000,    3.3370,    2.7470,    3.3150,    2.3700; ...       % 11 tau, 1C TC
        1.9370,    2.5670,    1.8660,    2.7630,    2.4930,    2.6680,    2.0630; ...       % 11 tau, 2C T2
        ];
...
DBV = [ 4.8760,    6.2500,    4.4210,    5.3630,    5.7620,    5.8370,    5.1960; ...
        ...
        5.0890,    4.8930,    4.6140,    4.7260,    5.7150,    5.0050,    4.0200; ...
        3.6570,    4.5340,    3.4720,    4.5560,    5.6670,    4.3680,    3.9400; ...
        ];
...
OEF = [ 23.9600,   20.4800,   22.8200,   21.0800,   19.9900,   23.3800,   18.2400; ...
        ...
        19.7200,   18.9700,   22.9000,   20.9600,   17.2500,   20.9800,   18.7800; ...
        14.9800,   15.6600,   16.1100,   17.0600,   14.3400,   17.1000,   16.1400; ...
        ];
