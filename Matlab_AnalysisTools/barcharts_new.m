...
%       LinMean    1C.Mean    2C.Mean 
R2p = [ 3.1080,    3.3970,    3.2640; ...
        3.7420,    3.6550,    3.6320; ...
        2.5830,    2.8720,    3.2210; ...
        2.8570,    3.3930,    3.2280; ...
        3.0930,    3.6480,    3.5060; ...
        3.5020,    3.7880,    3.6460; ...
        2.6210,    2.6570,    2.6260 ];
    
%       LinMean    1C.Mean    2C.Mean 
DBV = [ 4.2340,    6.1380,    5.7560; ...
        6.0780,    5.5060,    5.7880; ...
        3.6830,    5.2450,    5.9120; ...
        4.3860,    6.4270,    6.0070; ...
        4.9810,    8.5910,    7.6490; ...
        5.0860,    6.3730,    6.2360; ...
        4.6710,    5.5250,    5.1970 ];

%       LinMean    1C.Mean    2C.Mean 
OEF = [ 28.9100,   34.2400,   33.6600; ...
        24.9300,   32.8100,   35.7300; ...
        26.6700,   29.5500,   31.9000; ...
        24.9000,   24.7700,   28.8300; ...
        25.0100,   19.9400,   22.4500; ...
        28.2000,   31.7400,   34.7300; ...
        24.9100,   24.7300,   24.2100 ];
...
%        LinStd     1C.Std     2C.Std
eR2p = [ 1.8640,    2.3070,    2.1300; ...
         2.8790,    2.8520,    3.0750; ...
         2.2450,    2.6690,    1.8850; ...
         2.2150,    2.4930,    2.5060; ...
         2.4620,    2.9180,    2.7950; ...
         2.6700,    2.8990,    2.7660; ...
         2.2560,    2.5090,    2.4970 ];
     
%        LinStd     1C.Std     2C.Std
eDBV = [ 3.4150,   11.4000,   10.6500; ...
         5.9700,    8.0100,    9.2290; ...
         3.3070,   10.0900,    9.1470; ...
         3.9190,    7.6240,    8.7380; ...
         4.6540,   10.3700,    8.7150; ...
         6.2740,   10.1200,   10.6400; ...
         5.8830,    9.7480,    8.7100 ];
    
%        LinStd     1C.Std     2C.Std
eOEF = [ 18.1000,   27.3200,   25.9100; ...
         16.2400,   27.7300,   28.4400; ...
         18.7000,   23.4100,   26.4000; ...
         15.7900,   22.1800,   24.6200; ...
         16.7600,   16.5700,   19.3800; ...
         17.2000,   25.6000,   26.3800; ...
         18.1000,   19.1600,   18.1600 ];
