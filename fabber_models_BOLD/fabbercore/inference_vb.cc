...
{ 
  ...
  // Call ancestor, which does most of the real work - generates noise model
  ...
  // test number of parameters against priors and initial posterior 
...
*/
  ...
  for (int voxel = 1; voxel <= Nvoxels; voxel++)
	...
	model->pass_in_data( y );   // pass data for calculations
      }
