...
// MTC - this could be important in setting up spatially distinct priors
void SpatialVariationalBayes::SetupPerVoxelDists(FabberRunData &allData)
{
    ...
    // MTC - this is the thing that we want to manipulate, we want to be able to save out
    // and then insert our own version of resultMVNs, generated by a previous run:
