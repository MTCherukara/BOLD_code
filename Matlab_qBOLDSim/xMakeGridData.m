...
fulldata = load(['../../Data/vesselsim_data/vs_arrays/TE84_vsData_single_ND_R_',num2str(RR),'.mat']);
...
%% Save out
dname = strcat('ASE_Grid_SingleND_50x50_TE_',num2str(1000*TE),'_R_',num2str(RR));
