  ...
  for (int i = 1; i <= centre.Nrows(); i++)
    {
      ...
      /*
      // print out some stuff so we can see what's going on:
      cout << "\n---Evaluating the gradient wrt. variable " << i << "\n:";
      cout << "      Centre2 = " << centre2(i) << "\n";
      cout << "      Centre3 = " << centre3(i) << "\n";
      // cout << "      Value = " << jacobian.Column(i) << "\n"; */
